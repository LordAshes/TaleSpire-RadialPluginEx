...
namespace LordAshes
{
    [BepInPlugin(Guid, "Plugins Radial Plugin Ex Plug-In", Version)]
    [BepInDependency(RadialUI.RadialUIPlugin.Guid)]
    public class RadialPluginEx : BaseUnityPlugin
    {
        // Plugin info
        public const string Guid = "org.lordashes.plugins.radialpluginex";
        ...
        // Hold subentries for main menus
        ...
        void Awake()
        {
            UnityEngine.Debug.Log("Lord Ashes' Plugins Radial SubMenu Plugin Active.");
        }
        ...
        public static void CreateSubMenuItem(string mainGuid, string title, Sprite icon, Action<CreatureGuid, string, MapMenuItem> callback)
        {
            ...
            {
                // Parent plugin specificed callback for when the sub-menu item is selected
